...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/zewelor/hass-hidrograficopt?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=hass-hidrograficopt&category=integration)
...
1. Download the `custom_components/hidrograficopt/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=hidrograficopt)
...
3. Search for "Instituto Hidrográfico Integration"
...
1. Go to **Settings** → **Devices & Services**
2. Find **Instituto Hidrográfico Integration**
...
Find all entities in **Settings** → **Devices & Services** → **Instituto Hidrográfico Integration** → click on the device.
...
```yaml
service: hidrograficopt.example_action
data:
...
logger:
  default: info
  logs:
    custom_components.hidrograficopt: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Instituto Hidrográfico Integration → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@zewelor][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/zewelor/hass-hidrograficopt.svg?style=for-the-badge
[commits]: https://github.com/zewelor/hass-hidrograficopt/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/zewelor/hass-hidrograficopt.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40zewelor-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/zewelor/hass-hidrograficopt.svg?style=for-the-badge
[releases]: https://github.com/zewelor/hass-hidrograficopt/releases
