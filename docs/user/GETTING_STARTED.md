# Getting Started with Instituto Hidrográfico Integration

This guide will help you install and set up the Instituto Hidrográfico Integration custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/zewelor/hass-hidrograficopt`
6. Set category to "Integration"
7. Click "Add"
8. Find "Instituto Hidrográfico Integration" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/zewelor/hass-hidrograficopt/releases)
2. Extract the `hidrograficopt` folder from the archive
3. Copy it to `custom_components/hidrograficopt/` in your Home Assistant configuration directory
...
4. Select entities from "Instituto Hidrográfico Integration"
...
- Report issues at [GitHub Issues](https://github.com/zewelor/hass-hidrograficopt/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/zewelor/hass-hidrograficopt/discussions)
