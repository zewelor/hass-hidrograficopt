"""
Data update coordinator package for hidrograficopt.
...
from .base import InstitutoHidrogrficoDataUpdateCoordinator

__all__ = ["InstitutoHidrogrficoDataUpdateCoordinator"]
