...
from custom_components.hidrograficopt.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.hidrograficopt.config_flow_handler.validators import validate_credentials
...
ERROR_MAP = {
    "InstitutoHidrogrficoApiClientAuthenticationError": "auth",
    "InstitutoHidrogrficoApiClientCommunicationError": "connection",
}
    ...
    async def async_step_user(
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "documentation_url": "https://github.com/zewelor/hass-hidrograficopt",
            },
        )
