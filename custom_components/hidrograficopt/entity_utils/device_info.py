"""Device info utilities for hidrograficopt."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Instituto Hidrográfico Integration",
        manufacturer=manufacturer or "Instituto Hidrográfico Integration",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('hidrograficopt', 'entry_id_value')}
    """
