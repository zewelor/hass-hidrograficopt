...
- Inherit from `InstitutoHidrogrficoEntity` and platform base class
...
- Entity: `custom_components/hidrograficopt/[platform]/[entity_name].py`
- Platform: `custom_components/hidrograficopt/[platform]/__init__.py`
