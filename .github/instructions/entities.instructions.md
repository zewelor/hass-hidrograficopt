...
- **`entity/`** - Base entity classes (inherit `InstitutoHidrogrficoEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, InstitutoHidrogrficoEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import InstitutoHidrogrficoEntity`
